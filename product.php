                ...
                <div id="products_search_wrap">
                    <form method="POST">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <select class="form-control" name="search_category_id" id="search_category_id"
                                    onchange="fetchSeachProducts()">
                            ...
                            <div class="col-md-1">
                                <a class="btn btn-primary" onclick="fetchSeachProducts()"><span
            ...
            <form class="form-horizontal" id="submitProductForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body" style="max-height:450px; overflow:auto;">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="kv-avatar center-block">
                                <input type="file" class="form-control" id="productImage" placeholder="Product Name"
                                    name="picture" class="file-loading" style="width:auto;" />
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type='number' step='0.01' value='0.00' placeholder='0.00' class="form-control"
                                id="price" name="price" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control datepick" name="expiration_date" id="expiration_date"
                                required>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-body" style="max-height:450px; overflow:auto;">
                ...
                <div class="div-result">
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#productInfo" aria-controls="profile" role="tab"
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="productInfo">
                            <form class="form-horizontal" id="editProductForm" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="editPrice" placeholder="Price"
                                            name="editPrice" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="editExpirationDate" class="col-sm-3 control-label">Expiration date:
                                    </label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="editExpirationDate"
                                            placeholder="Expiration date" name="editExpirationDate" autocomplete="off"
                                            required>
                                    </div>
                                </div>
